...
const serviceMetaMap: Record<string, { title: string; description: string; keywords: string[] }> = {
  bridge: {
    title: "Steel Bridge Construction & Structural Erection | Structro Infratech Assam",
    description:
      "Top steel bridge construction, structural erection, and civil & structural works in Guwahati, Assam. Specializing in railway bridges, heavy steel structures, and major infrastructure projects in Northeast India.",
    keywords: [
  ...
  peb: {
    title: "PEB Buildings & Industrial Shed Fabrication Guwahati | Structro Infratech",
    description:
      "Northeast India's leading PEB contractor. Pre-Engineered Buildings (PEB), industrial shed fabrication, warehouse construction, and factory building construction in Assam & Guwahati. ISO 9001:2015 certified.",
    keywords: [
  ...
  design: {
    title: "Structural Engineering & Design Solutions Guwahati | Structro Infratech",
    description:
      "Professional structural engineering, mechanical engineering services, engineering works, and industrial engineering solutions. Structro Infratech provides turnkey engineering projects and structural drawings in Guwahati, Assam.",
    keywords: [
  ...
  steel: {
    title: "Structural Steel Fabrication & Erection Guwahati | Structro Infratech",
    description:
      "Expert structural steel fabrication, MS fabrication, welding services, and steel erection in Guwahati, Assam. Designing heavy steel structures, conveyor structures, platforms, and staircase fabrication across Northeast India.",
    keywords: [
      ...
      "Steel Erection",
      "Structural Erection",
      "Platform & Staircase Fabrication",
  ...
  "special-metal": {
    title: "Special Metal & SS Fabrication Guwahati | Custom Metal Works | Structro",
    description:
      "High-precision SS fabrication, pipe fabrication, tank fabrication, sheet metal fabrication, and welding services in Guwahati, Assam. Specialized custom metal works for industrial maintenance in Northeast India.",
    keywords: [
      "SS Fabrication",
      "Pipe Fabrication",
      "Tank Fabrication",
