        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1 h-[450px] sm:h-[500px]">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="absolute top-0 left-0 w-[90%] sm:w-[80%] max-w-[400px] bg-white p-6 sm:p-8 shadow-xl rounded-sm border-l-4 border-red-600 z-10"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-50 rounded-full flex items-center justify-center mb-4 sm:mb-6">
                <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-red-600" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3">Avoid Delays</h3>
              <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">Time overruns are profit killers. We stick to our schedules rigorously, using advanced modular techniques to beat deadlines.</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute bottom-0 right-0 w-[95%] sm:w-[85%] max-w-[420px] bg-[#001e40] p-6 sm:p-8 shadow-2xl rounded-sm z-20"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#ea8000]/20 rounded-full flex items-center justify-center mb-4 sm:mb-6">
                <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6 text-[#ea8000]" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3">Guaranteed Execution</h3>
              <p className="text-gray-300 text-xs sm:text-sm leading-relaxed">From foundation laying to final superstructure, we handle the complexity so you can focus on your business.</p>
            </motion.div>
          </div>
